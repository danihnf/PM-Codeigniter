...
<div class="navbar navbar-default navbar-static-top">
        ...
        <div class="section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                        <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>admin/simpan" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                ...
                                <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                    <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Program"></textarea>
                                </div>
                        </div>
                        ...
                        <div class="date col-sm-6 input-group" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                                    <input type="text" class="form-control" name="progress" size="20" value="<?php echo $progress; ?>" placeholder="Proses Pembuatan">
                                </div>
                            </div>
